...
{ 
  ...
  var others = new Array();
		...
		others[0].push([[[44]],   [4],   [2]]);
		others[0].push([[[65, 90]],   [5],   [3]]);
		others[0].push([[[123]],   [2],   [4]]);
		others[0].push([[[125]],   [3],   [5]]);
		others[1] = new Array();
		others[2] = new Array();
		others[3] = new Array();
		others[4] = new Array();
  ...
  switch( state )
{
	case 0:
		...
		else if( (( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 90 ) )) state = 3;
		else if( (info.src.charCodeAt( pos ) == 123 )) state = 4;
		else if( (info.src.charCodeAt( pos ) == 125 )) state = 5;
		else state = -1;
   	last_state = 0;
		break;
                      ...
                      var transitions_matches = findAllTransitionsMatches(source);                                                
                       ...
                       {        
                             ...
                             // now we have in matches_transitions strings in format: (regex) "tokens_regex" [TOKEN_NAME]      
                              ...
                              if(difference(expected,[10]).length) result.error_string += LANG.canCont             
                                                  +    " {" +   getExpectedLabels(difference(expected,[10])).join(", ") + "}. "
                                                  + ((isProblematicWhitespace(source))? LANG.maybeWhitespace:"");
...
parseTable[0][2] = createLL1TabEntry(false, [5, 10], null, false, false);
parseTable[0][3] = createLL1TabEntry(false, [5, 10], null, false, false);
parseTable[0][4] = createLL1TabEntry(false, [5, 10], null, false, false);
parseTable[0][5] = createLL1TabEntry(false, null, [7], false, false);
parseTable[0][10] = createLL1TabEntry(false, null, [7], false, false);
...
parseTable[6][2] = createLL1TabEntry(false, [5], null, false, false);
parseTable[6][3] = createLL1TabEntry(false, [5], null, false, false);
parseTable[6][4] = createLL1TabEntry(false, [5], null, false, false);
parseTable[6][5] = createLL1TabEntry(false, null, [8, 9], false, false);
parseTable[6][10] = createLL1TabEntry(false, [5], null, false, false);
parseTable[7] = new Array();
parseTable[7][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[7][2] = createLL1TabEntry(false, [5, 10], null, false, false);
parseTable[7][3] = createLL1TabEntry(false, [5, 10], null, false, false);
parseTable[7][4] = createLL1TabEntry(false, [5, 10], null, false, false);
parseTable[7][5] = createLL1TabEntry(false, null, [6], false, false);
parseTable[7][10] = createLL1TabEntry(false, null, [], false, false);
parseTable[8] = new Array();
parseTable[8][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[8][2] = createLL1TabEntry(false, [5], null, false, false);
parseTable[8][3] = createLL1TabEntry(false, [5], null, false, false);
parseTable[8][4] = createLL1TabEntry(false, [5], null, false, false);
parseTable[8][5] = createLL1TabEntry(false, null, [5], false, false);
parseTable[8][10] = createLL1TabEntry(false, [5], null, false, false);
parseTable[9] = new Array();
parseTable[9][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[9][2] = createLL1TabEntry(false, [4, 10], null, false, false);
parseTable[9][3] = createLL1TabEntry(false, [4, 10], null, false, false);
parseTable[9][4] = createLL1TabEntry(false, null, [4, 8, 9], false, false);
parseTable[9][5] = createLL1TabEntry(false, [4, 10], null, false, false);
parseTable[9][10] = createLL1TabEntry(false, null, [], false, false);
...
parseTable[10][10] = createLL1TabEntry(false, null, null, true, false);
...
var labels = new Array(
	...
	"Nonterminals" /* Non-terminal symbol */,
	"Start" /* Non-terminal symbol */,
